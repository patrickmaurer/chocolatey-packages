try {
	...
	Get-ChocolateyWebFile 'crystalreports-for-visualstudio' "$toolsDir\CRforVS_13_0_12.exe" 'http://downloads.businessobjects.com/akdlm/cr4vs2010/CRforVS_13_0_12.exe'
	Get-ChocolateyUnzip "$toolsDir\CRforVS_13_0_12.exe" "$toolsDir\CRforVS_13_0_12"
	Remove-Item "$toolsDir\CRforVS_13_0_12.exe"
	...
	if ($is64bit) {
		$runtimeFileFullPath = get-childitem $toolsDir -recurse -include CRRuntime_64bit_13_0_12.msi | select -First 1
	...
	Remove-Item "$toolsDir\CRforVS_13_0_12" -recurse
