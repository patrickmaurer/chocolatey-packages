...
$packageName = 'BoxCryptorClassic' # arbitrary name for the package, used in messages
$installerType = 'MSI' #only one of these two: exe or msi
$url = 'https://www.boxcryptor.com/download/Boxcryptor_Classic_Setup.msi' # download url
