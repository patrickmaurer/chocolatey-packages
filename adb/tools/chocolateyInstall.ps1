$packageName = 'adb'
$url = 'https://dl-ssl.google.com/android/repository/platform-tools_r29.0.1-windows.zip'
$checksum = '2334F92CF571FD2D9BF6FF7C637765BEE5D8323E0BD8E051E15927D87B54B4E8'
$checksumType = 'sha256'
