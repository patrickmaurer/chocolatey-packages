$packageName = 'adb'
$url = 'https://dl-ssl.google.com/android/repository/platform-tools_r28.0.0-windows.zip'
$checksum = 'E2C1EC7C8E9B71CF1C8BEFD3BFF91D06B26DD334C3F32B3817E9D46BA260B0E8'
$checksumType = 'sha256'
