$packageName = 'adb'
$url = 'https://dl-ssl.google.com/android/repository/platform-tools_r30.0.3-windows.zip'
$checksum = '5C8FB6D72DA581BAA608A38853D05AEEAF920F2AC9CA2CB463D9FD62ACB0871B'
$checksumType = 'sha256'
