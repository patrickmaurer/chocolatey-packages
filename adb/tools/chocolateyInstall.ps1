$packageName = 'adb'
$url = 'https://dl-ssl.google.com/android/repository/platform-tools_r29.0.6-windows.zip'
$checksum = '247210E3C12453545F8E1F76E55DE3559C03F2D785487B2E4AC00FE9698A039C'
$checksumType = 'sha256'
