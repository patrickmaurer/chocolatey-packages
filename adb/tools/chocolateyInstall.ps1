$packageName = 'adb'
$url = 'https://dl-ssl.google.com/android/repository/platform-tools_r28.0.2-windows.zip'
$checksum = '6A721560633BABEBC74F9330D7184A23D74D18B835CC769F81BBF977575B3800'
$checksumType = 'sha256'
