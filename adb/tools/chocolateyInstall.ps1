$packageName = 'adb'
$url = 'https://dl-ssl.google.com/android/repository/platform-tools_r30.0.4-windows.zip'
$checksum = '413182FFF6C5957911E231B9E97E6BE4FC6A539035E3DFB580B5C54BD5950FEE'
$checksumType = 'sha256'
