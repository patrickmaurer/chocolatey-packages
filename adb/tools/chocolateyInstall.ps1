$packageName = 'adb'
$url = 'https://dl-ssl.google.com/android/repository/platform-tools_r28.0.1-windows.zip'
$checksum = 'DB78F726D5DC653706DCD15A462AB1B946C643F598DF76906C4C1858411C54DF'
$checksumType = 'sha256'
